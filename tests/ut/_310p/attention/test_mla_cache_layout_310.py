...
class TestMLACacheLayout310(TestBase):
    ...
    def test_mla_cache_layout_mismatch_bug(self):
        ...
        # This should fail because the layout is incorrect
        ...
        # Verify that wrong layout produces incorrect data
        # The view() approach swaps block_size and num_kv_heads axes
        # which leads to reading from wrong positions
        with pytest.raises(AssertionError):
            for i, slot in enumerate(slots):
                ...
                # Try to read with wrong layout - this should fail
                # because the axes are swapped
                assert torch.allclose(
                    k_nope_wrong[i, head_idx, offset, :],
